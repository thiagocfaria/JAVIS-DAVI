"""
Utilitarios e contratos comuns para audio de entrada.

Mantem constantes de formato e normalizacao para evitar tipos inesperados.
"""
...
# Formato padrao de audio: PCM int16 mono a 16 kHz.
SAMPLE_RATE = 16000
BYTES_PER_SAMPLE = 2
...
def coerce_pcm_bytes(payload: Any) -> bytes:
    """
    Normaliza conteineres PCM para bytes (int16 little-endian mono).
